...
namespace TraineeHelper.Web.Models
{
    ...
    public class SetUserNameBindingModel
    {
        [Required]
        [StringLength(20, ErrorMessage = "The {0} must be at least {2} characters long.", MinimumLength = 5)]
        [DataType(DataType.Text)]
    ...
    public class SetPhoneVisibilityBindingModel
    {
        [Required]
        public bool PhoneVisibility { get; set; }  
    }
    ...
    public class RequestConnectionBindingModel
    {
        [Required]
